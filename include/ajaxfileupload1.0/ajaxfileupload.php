		...
		(
			{
				...
				success: function (data, status)
				{
					if(typeof(data.error) != 'undefined')
					{
						...
						{
							//alert(data.msg);
							//alert("http://127.0.0.1:8080/luxmotor/userfiles/category/" + data.msg);
							document.getElementById("picdone").src = "http://127.0.0.1:8080/luxmotor/userfiles/category/" + data.msg;
						}
					}
				},
